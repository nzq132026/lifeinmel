...
<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/style/type/fontawesome/css/all.css">
    ...
    <nav class="navbar transparent absolute nav-wrapper-dark inverse-text navbar-expand-lg text-uppercase">
      <div class="container">
        <div class="navbar-header">
          <div class="navbar-brand"><a href="index.html"><img src="#" srcset="<?php echo get_stylesheet_directory_uri(); ?>/style/images/logo-light.png 1x, <?php echo get_stylesheet_directory_uri(); ?>/style/images/logo-light@2x.png 2x" alt="" /></a></div>
        ...
        <?php
          ...
          <ul class="social social-mute social-s">
            <li><a href="https://weibo.com/shippo0714" target="_blank"><i class="fab fa-weibo"></i></a></li>
            <li><a href="https://www.instagram.com/ailurophile_n/" target="_blank"><i class="fab fa-instagram"></i></a></li>
          </ul>
      </div>
    </nav>
  </header>